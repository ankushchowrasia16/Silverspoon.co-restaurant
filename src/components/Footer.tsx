    ...
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#menu-section" className="hover:text-primary-500 transition-colors">Menu</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>hello@silverspoon.co</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 text-primary-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-6 border-t border-gray-800 text-center text-sm">
          ...
          <p className="mt-2 text-gray-500">Built with ❤️ for amazing food lovers</p>
        </div>
      </div>
    </footer>
  );
