    ...
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3 className="text-xl font-heading font-bold text-white mb-4">
              Silver Spoon <span className="text-primary-500">.Co</span>
            </h3>
            ...
            <div className="flex gap-3">
              <a
                href="https://www.instagram.com/ankushchowrasia/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100074737849819"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-full flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
                aria-label="Facebook"
              ...
              <a
                href="https://www.linkedin.com/in/ankushchowrasia27/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-full flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/" className="hover:text-primary-500 transition-colors">Menu</Link></li>
              ...
              <li><Link to="/reservations" className="hover:text-primary-500 transition-colors">Reservations</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-6 border-t border-gray-800 text-center text-sm">
          <p>&copy; {currentYear} Silver Spoon .Co. All rights reserved.</p>
          <div className="mt-2 flex items-center justify-center gap-2">
            <span className="text-gray-500">Made by</span>
            <a
              href="https://ankushchowrasia.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-3 py-1 border-2 border-primary-500 rounded-full text-gray-300 hover:text-white hover:bg-primary-500 transition-colors font-medium"
            >
              Ankush Chowrasia
            </a>
          </div>
